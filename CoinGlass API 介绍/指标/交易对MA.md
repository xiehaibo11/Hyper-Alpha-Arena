...
```json
{
  ...
  "paths": {
    "/api/futures/indicators/ma": {
      "get": {
        "description": "",
        "operationId": "get_apifuturesindicatorsrsi-1",
        "responses": {
          "200": {
            "description": ""
          }
        ...
        "parameters": [
          ...
          },
          {
            ...
            "description": "Window size — defines the number of data points used for indicator calculation (e.g., 10 for MA)."
          },
          {
            "in": "query",
            "name": "series_type",
