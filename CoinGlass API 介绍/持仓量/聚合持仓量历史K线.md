  ...
  "paths": {
    "/api/futures/open-interest/aggregated-history": {
      "get": {
        ...
        "description": "This API presents aggregated open interest data using OHLC (Open, High, Low, Close) candlestick charts.",
        "operationId": "oi-ohlc-aggregated-history",
        "parameters": [
          {
            "name": "symbol",
            "in": "query",
