...
TOOL_LABELS = {
    ...
    "inspect_project_health": {"en": "Inspecting project health",   "zh": "正在检查项目健康"},
    "run_safe_project_repair":{"en": "Running safe repair",          "zh": "正在执行安全修复"},
    "read_project_file":      {"en": "Reading project file",         "zh": "正在读取项目文件"},
    "write_project_file":     {"en": "Editing project file",         "zh": "正在修改项目文件"},
    "run_project_command":    {"en": "Running project command",      "zh": "正在执行项目命令"},
    "restart_backend_service":{"en": "Restarting backend",           "zh": "正在重启后端服务"},
    "coordinate_all_ai":      {"en": "Coordinating all AI modules",  "zh": "正在协调全部AI模块"},
    ...
    "run_dream_review":       {"en": "Running dream review",        "zh": "正在做梦复盘"},
